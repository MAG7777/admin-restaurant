...
import { ITouristRoutesItem } from 'store/slices/touristRoutes/interfaces';

interface IProps {
  data: ITouristRoutesItem[];
  total: number;
  limit?: number;
  getActions: (item: ITouristRoutesItem) => Array<
    | {
        element: JSX.Element;
        handler?: undefined;
      }
